"""
Section 16 - Sandboxing II: audit every sandboxed execution.
...
def audit_record(*, tool, command, decision, exit_code, duration_ms):
    ...
    widely readable (Section 9). So we keep a short, truncated PREVIEW for humans plus a
