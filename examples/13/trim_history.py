"""
Section 13 - Keeping history inside the budget: windowing and summarizing.

As a conversation grows, the resent history eats more of the context window
(Section 4) and costs more (Section 11). Two common fixes:
  ...
  2. Summarize       -- replace old turns with a short model-written summary.
    ...
    python examples/13/trim_history.py
"""
