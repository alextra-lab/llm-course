"""
Section 13 - Conversation state: the API is stateless; YOU keep the history.
...
grow.
    ...
    python examples/13/chat_loop.py
"""
...
print("entire history each time. That's what Section 13 is about managing.")
