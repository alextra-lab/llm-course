"""
Section 17 - Sandboxing II: run untrusted SQL safely against Postgres (OPT-IN).
...
OPT-IN: set DATABASE_URL to a throwaway DEV database you control, e.g.
    DATABASE_URL=postgresql://user:pass@localhost:5432/devdb python examples/17/pg_sandbox.py
