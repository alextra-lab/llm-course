"""
Section 17 - Sandboxing II: run untrusted code in a hardened container.

The portable limits from Section 16 cap CPU/memory but don't really isolate the
...
still read along (the same "degrade gracefully" habit the course uses elsewhere).
    ...
    python examples/17/docker_exec.py
"""
