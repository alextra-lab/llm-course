"""
Section 15 - The tool-use loop: one round trip becomes a loop.

Section 14 ran a tool once, by hand. Here we loop: call the model, run any tools
...
(or we hit a step cap). That loop, with a few tools, is a mini-agent.
    ...
    python examples/15/agent_loop.py
"""
