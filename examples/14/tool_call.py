"""
Section 14 - Tool calling: let the model call YOUR code.
...
This is ONE round trip done by hand. Section 15 turns it into a loop.

    python examples/14/tool_call.py
...
def calculate(expression: str) -> str:
    ...
    # eval() on model-provided text; Section 21 explains why that matters.
    def ev(node):
