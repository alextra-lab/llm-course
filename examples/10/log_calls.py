"""
Section 10 - Observability: log one structured record per call.
...
call; these tie many calls into one story. See Section 23 for where this pays off.

JSON-per-line ("JSONL") logs are easy for both humans and tools to read.

    python examples/10/log_calls.py
"""
