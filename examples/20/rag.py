"""
Section 20 - Retrieval-Augmented Generation: answer from YOUR documents.
...
relevant to the question (Section 19), put them in the prompt, and tell the model
to answer ONLY from that context.

    python examples/20/rag.py
"""
...
if not EMBED_MODEL:
    raise SystemExit("Set EMBED_MODEL in your .env (see examples/19/embed.py).")
