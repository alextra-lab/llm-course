...
linkTitle: '5. Sampling Parameters (Seeing the Effect)'
weight: 5
---
...
**Where this fits:** Sections 1–4 were about *what* you send and receive. This is the
...
> (Section 6) is a strong combination. *(Reference:
> [`examples/05/temperature_sweep.py`](../examples/05/temperature_sweep.py).)*
...
> *(Reference: [`examples/05/seed_demo.py`](../examples/05/seed_demo.py).)*
